    ...
    <div class="row justify-content-center">
        <div class="col-md-12 main-body">
            <section class="window-title">
                ...
                <small>
                    <a href="/admin/passenger">Passenger's List</a> > View
                </small>
                <a href="#" onclick="window.open('/admin/print/passenger/{{$row->passenger_id}}');" 
                    class="print btn pull-right">
            ...
            <div class="card">
                ...
                <div class="col-md-12 body-container">
                    ...
                    <div class="col-md-4 float-left">
                        <center>
                        <section class="p-3">
                            {{QrCode::size(200)->generate($jsonData)}}
                        </section>
                        <section class="p-3">
                            @if($row->profile_picture === 'default_photo.png')
                                <img src="{{asset('images/default_photo.png')}}" height="200" width="200" alt="USER">
                            @else
                            <img src="/storage/user_images/{{$row->profile_picture}}" height="200" class="profile_picture" width="200" alt="USER">
                            @endif
                        </section>
                        </center>
                    </div>
            ...
            <div class="col-md-12 window-title my-2 p-1 px-3">
                ...
                @if(isset($_GET['date_from']) && isset($_GET['date_to']))
                    ...
                    <!-- <a href="#" onclick="window.open('/admin/logs/passenger/{{$row->passenger_id}}?_token='+token+'&date_from='+date_from+'&date_to='+date_to);" 
                ...
                @else
                    <!-- <a href="#" onclick="window.open('/admin/logs/passenger/{{$row->passenger_id}}');" 
                        class="print btn pull-right mt-2">
                    <i class="fa fa-print"></i> PRINT
                    </a> -->
